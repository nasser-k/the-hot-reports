        ...
        <div className="max-w-[1400px] mx-auto px-4 py-0.5 sm:py-1 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 lg:flex-none text-center lg:text-left">
            <Link href="/" className="inline-block">
              <img src="/logo.png" alt="Pulse of Kigezi" className="h-20 w-20 sm:h-28 sm:w-28 lg:h-32 lg:w-32 rounded-lg object-cover" />
            </Link>
          </div>
                  ...
                  {tourismOpen && (
                    <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl z-50 w-[520px] overflow-hidden">
                      ...
                      <div className="bg-gradient-to-r from-gray-950 to-red-950 px-6 py-4">
                        <h3 className="text-white font-black text-sm sm:text-base">Explore Kigezi</h3>
          ...
          <div className="absolute inset-y-0 left-0 w-[320px] max-w-[88vw] bg-white dark:bg-gray-950 shadow-2xl overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800">
              <Link href="/" onClick={() => setMobileOpen(false)} className="inline-block">
                <img src="/logo.png" alt="Pulse of Kigezi" className="h-16 w-16 rounded-lg object-cover" />
              </Link>
              <button
                onClick={() => setMobileOpen(false)}
                className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
            ...
            <div className="px-5 py-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <a href={`https://tiktok.com/${process.env.NEXT_PUBLIC_TIKTOK_HANDLE || '@pulseofkigezi'}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-full text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-colors" aria-label="TikTok"><TikTokIcon size={14} /></a>
                <a href={`https://youtube.com/${process.env.NEXT_PUBLIC_YOUTUBE_CHANNEL || '@PulseofKigezi'}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-full text-gray-500 hover:text-red-600 transition-colors" aria-label="YouTube"><Youtube size={14} /></a>
              </div>
              <button
                onClick={toggleTheme}

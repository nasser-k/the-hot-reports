...
/**
 * Static utility bar with date, links, and social media
 * This is a server component that doesn't re-render
 */
export default function UtilityBar() {
  ...
  return (
    <div className="hidden lg:block bg-gray-950 text-gray-300 text-[11px]">
      <div className="max-w-[1400px] mx-auto px-4 flex items-center justify-between h-8">

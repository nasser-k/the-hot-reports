...
| Name | Slug | Color |
|------|------|-------|
| Kigezi News | kigezi-news | #059669 |
...
```json
{
  ...
  "category": { "name": "Kigezi News", "slug": "kigezi-news", "color": "#059669" },
  ...
  "metaTitle": "Kabale Gets Modern Market Complex | Pulse of Kigezi",
...
```json
{
  ...
  "excerpt": "At least 12 families displaced as torrential rains pound the Kigezi sub-region for the third consecutive day.",
...
```json
{
  ...
  "metaDescription": "Young Bakiga lead cultural renaissance in Kigezi. Traditional dance, language festivals draw thousands. Full story.",
...
```json
{
  ...
  "metaTitle": "Safaricom 5G Arrives in Kigezi | Technology News",
...
```json
{
  ...
  "excerpt": "New policy will benefit 500,000 additional students nationwide, including thousands from Kigezi region.",
...
```json
{
  ...
  "location": "Kabale Town, with tours throughout Kigezi sub-region",
  "priceRange": "$120 – $450",
  "rating": 4.9,
  "featured": false,
  ...
  "metaDescription": "Expert birding guides in Kigezi. 350+ species, Albertine Rift endemics. Day trips to multi-day expeditions.",
...
```json
{
  ...
  "metaDescription": "Family secrets erupt in inheritance battle. Village drama set in Kigezi highlands. New episodes weekly by Patricia Amoit."
}
```
...
```json
{
  ...
  "metaDescription": "A village girl discovers flight. True story of Captain Grace Mbabazi, from Kigezi hills to the cockpit. Episode 1."
}
```
